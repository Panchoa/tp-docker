    ...
    if (mysqli_num_rows($res) > 0) {
        ...
        <div class="ressources">
            ...
            foreach ($ressources as $ressource) {
                ...
                } elseif ($ressource['RE_type'] == 'obj') {
                    echo '<img src="data:image;base64, ' . base64_encode($minio->getObject($ressource['RE_nom'])) . '" class="img-thumbnail thumb" data-id="' . $ressource['RE_id'] . '">';
                }
            }
            ?>
